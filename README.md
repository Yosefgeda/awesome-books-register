...
- User_can_registers_books
- User_can_remove_books_from_list
...
- [ ] **[Project_will_be_refactored_to_use_JS_classes]**
- [ ] **[Navigations_will_be_added]**
...
Feel free to check the [issue page](https://github.com/Lornakaboro/Awesome-books/issues)
